...
import { Heart, ShoppingCart, Search, Star, Eye, Sparkles, Filter, Grid, List, MessageCircle } from 'lucide-react';
            ...
            <div className={`grid gap-8 ${viewMode === 'grid'
              ...
              {filteredPerfumes.map((perfume, index) => (
                ...
                >
                  ...
                  {/* Content Section */}
                  <CardContent
                    className={`p-4 sm:p-6 space-y-3 sm:space-y-4 relative ${viewMode === "list" ? "flex-1 flex flex-col justify-between" : ""
                      }`}
                  >
                    {/* Product Info */}
